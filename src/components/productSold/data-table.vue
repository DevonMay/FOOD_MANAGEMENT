...
<LayoutDefault>
              ...
              <b-row>
                <b-col>
                  ...
                  >
                    ...
                    <span class="h6 text-white">New Sold Product</span>
                  </b-button>
                </b-col>
              </b-row>
            </b-col>
                ...
                <b-row>
                  <b-col cols="7">
                    <b-icon-pencil-square
                      class="action-item"
                      variant="primary"
                      @click="getRowData(data.item.productID)"
                    ></b-icon-pencil-square>
                  </b-col>
                <b-col cols="1">
                    <b-icon-trash-fill
                      class="action-item"
                      variant="danger"
                      @click="showDeleteModal(data.item.productID)"
                    ></b-icon-trash-fill>
                  </b-col>
                </b-row>
              </template>
  ...
  export default {
    ...
    methods: {
      ...
      getCustomerData() {
        axios
          .get("http://localhost:8083/api/productSold/all")
          .then((response) => {
            this.tableHeader = "Total Sold Products";
      ...
      setFilterTotalIsActive() {
        this.tableHeader = "Total Products Sold";
        this.getCustomerData();
      },
      setFilterActiveIsActive() {
        this.tableHeader = "Active Sold Products";
        this.items = this.activeCustomersData;
      },
      showAlertCreate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Sold Product was created successfully!";
      },
      showAlertUpdate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Sold Product was updated successfully";
      },
      showDeleteModal(id) {
      ...
      showDeleteSuccessModal() {
        this.showSuccessAlert = true;
        this.alertMessage = "Sold Product was deleted successfully!";
      },
    },
  };
  </script>
