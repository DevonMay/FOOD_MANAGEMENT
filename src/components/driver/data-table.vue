...
<LayoutDefault>
              ...
              <b-row>
                <b-col>
                  ...
                  >
                    ...
                    <span class="h6 text-white">New Driver</span>
                  </b-button>
                </b-col>
              </b-row>
            </b-col>
                ...
                <b-row>
                  <b-col cols="7">
                    <b-icon-pencil-square
                      class="action-item"
                      variant="primary"
                      @click="getRowData(data.item.driverID)"
                    ></b-icon-pencil-square>
                  </b-col>
                <b-col cols="1">
                    <b-icon-trash-fill
                      class="action-item"
                      variant="danger"
                      @click="showDeleteModal(data.item.driverID)"
                    ></b-icon-trash-fill>
                  </b-col>
                </b-row>
              </template>
  ...
  export default {
    ...
    methods: {
      ...
      getCustomerData() {
        axios
          .get("http://localhost:8083/api/driver/all")
          .then((response) => {
            this.tableHeader = "Total Driver";
      ...
      setFilterActiveIsActive() {
        this.tableHeader = "Active Driver";
        this.items = this.activeCustomersData;
      },
      showAlertCreate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Driver was created successfully!";
      },
      showAlertUpdate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Driver was updated successfully";
      },
      showDeleteModal(id) {
      ...
      showDeleteSuccessModal() {
        this.showSuccessAlert = true;
        this.alertMessage = "Driver was deleted successfully!";
      },
    },
  };
  </script>
