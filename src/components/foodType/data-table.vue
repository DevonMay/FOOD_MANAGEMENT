...
<LayoutDefault>
              ...
              <b-row>
                <b-col>
                  ...
                  >
                    ...
                    <span class="h6 text-white">New Food Type</span>
                  </b-button>
                </b-col>
              </b-row>
            </b-col>
                ...
                <b-row>
                  <b-col cols="7">
                    <b-icon-pencil-square
                      class="action-item"
                      variant="primary"
                      @click="getRowData(data.item.typeID)"
                    ></b-icon-pencil-square>
                  </b-col>
                <b-col cols="1">
                    <b-icon-trash-fill
                      class="action-item"
                      variant="danger"
                      @click="showDeleteModal(data.item.typeID)"
                    ></b-icon-trash-fill>
                  </b-col>
                </b-row>
              </template>
  ...
  export default {
    ...
    methods: {
      ...
      getCustomerData() {
        axios
          .get("http://localhost:8083/api/foodType/all")
          .then((response) => {
            this.tableHeader = "Total Food Types";
      ...
      setFilterActiveIsActive() {
        this.tableHeader = "Active Food Types";
        this.items = this.activeCustomersData;
      },
      showAlertCreate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Food Types was created successfully!";
      },
      showAlertUpdate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Food Types was updated successfully";
      },
      showDeleteModal(id) {
      ...
      showDeleteSuccessModal() {
        this.showSuccessAlert = true;
        this.alertMessage = "Food Types was deleted successfully!";
      },
    },
  };
  </script>
