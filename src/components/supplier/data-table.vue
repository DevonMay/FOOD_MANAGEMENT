...
<LayoutDefault>
              ...
              <b-row>
                <b-col>
                  ...
                  >
                    ...
                    <span class="h6 text-white">New Supplier</span>
                  </b-button>
                </b-col>
              </b-row>
            </b-col>
                ...
                <b-row>
                  <b-col cols="7">
                    <b-icon-pencil-square
                      class="action-item"
                      variant="primary"
                      @click="getRowData(data.item.supplierID)"
                    ></b-icon-pencil-square>
                  </b-col>
                <b-col cols="1">
                    <b-icon-trash-fill
                      class="action-item"
                      variant="danger"
                      @click="showDeleteModal(data.item.supplierID)"
                    ></b-icon-trash-fill>
                  </b-col>
                </b-row>
              </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
        {
          ...
          {
            key: "supplierFirstName",
            label: "Supplier First Name",
            sortable: false,
          },
          {
            key: "supplierLastName",
    ...
    methods: {
      ...
      getCustomerData() {
        axios
          .get("http://localhost:8083/api/supplier/all")
          .then((response) => {
            this.tableHeader = "Total Supplier";
      ...
      setFilterActiveIsActive() {
        this.tableHeader = "Active Supplier";
