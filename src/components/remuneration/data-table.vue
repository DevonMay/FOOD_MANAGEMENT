...
<LayoutDefault>
              ...
              <b-row>
                <b-col>
                  ...
                  >
                    ...
                    <span class="h6 text-white">New Remuneration</span>
                  </b-button>
                </b-col>
              </b-row>
            </b-col>
                ...
                <b-row>
                  <b-col cols="7">
                    <b-icon-pencil-square
                      class="action-item"
                      variant="primary"
                      @click="getRowData(data.item.remunerationID)"
                    ></b-icon-pencil-square>
                  </b-col>
                <b-col cols="1">
                    <b-icon-trash-fill
                      class="action-item"
                      variant="danger"
                      @click="showDeleteModal(data.item.remunerationID)"
                    ></b-icon-trash-fill>
                  </b-col>
                </b-row>
              </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [
        {
          ...
          {
            key: "remunerationDue",
            label: "Remuneration Due",
            sortable: false,
          },
          {
            key: "remunerationDescription",
            label: "Remuneration Description",
            sortable: false,
          },
          {
            key: "remunerationDate",
            label: "Remuneration Date",
            sortable: false,
          },
          "actions",
        ],
    ...
    methods: {
      ...
      getCustomerData() {
        axios
          .get("http://localhost:8083/api/remuneration/all")
          .then((response) => {
            this.tableHeader = "Total Remuneration";
      ...
      setFilterActiveIsActive() {
        this.tableHeader = "Active Remuneration";
        this.items = this.activeCustomersData;
      },
      showAlertCreate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Remuneration was created successfully!";
      },
      showAlertUpdate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Remuneration was updated successfully";
      },
      showDeleteModal(id) {
      ...
      showDeleteSuccessModal() {
        this.showSuccessAlert = true;
        this.alertMessage = "Remuneration was deleted successfully!";
      },
    },
  };
  </script>
