    ...
    <div>
      <b-row class="mt-2 mb-3">
        <h6 class="text-secondary">
          Are you sure you want to delete this Remuneration record?
        </h6>
      </b-row>
      <b-row class="mt-2 mb-3">
        <p class="text-danger">
  ...
  export default {
    ...
    methods: {
      ...
      removeCustomerFromData() {
        axios
          .delete(`http://localhost:8083/api/remuneration/delete/${this.customerId}`)
          .then(() => {
