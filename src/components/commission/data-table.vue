...
<LayoutDefault>
              ...
              <b-row>
                <b-col>
                  ...
                  >
                    ...
                    <span class="h6 text-white">New Commission</span>
                  </b-button>
                </b-col>
              </b-row>
            </b-col>
                ...
                <b-row>
                  <b-col cols="7">
                    <b-icon-pencil-square
                      class="action-item"
                      variant="primary"
                      @click="getRowData(data.item.commissionID)"
                    ></b-icon-pencil-square>
                  </b-col>
                <b-col cols="1">
                    <b-icon-trash-fill
                      class="action-item"
                      variant="danger"
                      @click="showDeleteModal(data.item.commissionID)"
                    ></b-icon-trash-fill>
                  </b-col>
                </b-row>
              </template>
  ...
  export default {
    ...
    methods: {
      ...
      getCustomerData() {
        axios
          .get("http://localhost:8083/api/commission/all")
          .then((response) => {
            this.tableHeader = "Total Commission";
      ...
      setFilterActiveIsActive() {
        this.tableHeader = "Active Commission";
        this.items = this.activeCustomersData;
      },
      showAlertCreate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Commission was created successfully!";
      },
      showAlertUpdate() {
        this.showSuccessAlert = true;
        this.alertMessage = "Commission was updated successfully";
      },
      showDeleteModal(id) {
      ...
      showDeleteSuccessModal() {
        this.showSuccessAlert = true;
        this.alertMessage = "Commission was deleted successfully!";
      },
    },
  };
  </script>
